...
namespace Persistence.Migrations
{
    ...
    [Migration("20230317113143_MakeEntitiesAuditable")]
    partial class MakeEntitiesAuditable
    {
            ...
            modelBuilder.Entity("Domain.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 3, 17, 11, 31, 42, 894, DateTimeKind.Utc).AddTicks(8845),
                            Name = "Business"
                        },
                        new
                        {
                            CategoryId = new Guid("1e6075a3-a411-42d0-9711-f901714c86df"),
                            CreatedDate = new DateTime(2023, 3, 17, 11, 31, 42, 894, DateTimeKind.Utc).AddTicks(8881),
                            Name = "Education"
                        },
                        new
                        {
                            CategoryId = new Guid("ed2fa5f2-0692-41f2-ba8e-4b41847b2c44"),
                            CreatedDate = new DateTime(2023, 3, 17, 11, 31, 42, 894, DateTimeKind.Utc).AddTicks(8892),
                            Name = "Entertainment"
                        },
                        new
                        {
                            CategoryId = new Guid("d3ee4713-ea7b-4097-9c99-3c6f585185d8"),
                            CreatedDate = new DateTime(2023, 3, 17, 11, 31, 42, 894, DateTimeKind.Utc).AddTicks(8910),
                            Name = "Medicine"
                        },
                        new
                        {
                            CategoryId = new Guid("3088c1ee-60be-45e8-bbb1-6d9f5b68365b"),
                            CreatedDate = new DateTime(2023, 3, 17, 11, 31, 42, 894, DateTimeKind.Utc).AddTicks(8933),
                            Name = "Utility"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Idea", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryId = new Guid("3088c1ee-60be-45e8-bbb1-6d9f5b68365b"),
                            CreatedDate = new DateTime(2023, 3, 17, 11, 31, 42, 894, DateTimeKind.Utc).AddTicks(8958),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("3088c1ee-60be-45e8-bbb1-6d9f5b68365b"),
                            CreatedDate = new DateTime(2023, 3, 17, 11, 31, 42, 894, DateTimeKind.Utc).AddTicks(8975),
